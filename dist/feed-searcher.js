export class FeedSearcher {
    ...
    searchInItems(items, feedName, keywords) {
    ...
    extractTrendingKeywords(items, minMentions = 3) {
...
//# sourceMappingURL=feed-searcher.js.map